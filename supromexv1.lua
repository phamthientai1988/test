...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Moon Hub") then
			makefolder("Moon Hub")
		end
		if not isfolder("Moon Hub/Blox Fruits/") then
			makefolder("Moon Hub/Blox Fruits/")
		end
		if not isfile("Moon Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("Moon Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("Moon Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Moon Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
			local Array = {}
			for i,v in pairs(_G.Settings) do
				Array[i] = v
			end
			writefile("Moon Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
