...
local Window = Library:CreateWindow({
    Title = 'Snow Hub V2 | Free Only | Version 2.0.0',
    Center = true, 
    AutoShow = true,
})
...
Library:SetWatermark('Snow Hub V2 | Free Only | Version 2.0.0 | https://discord.gg/3BD4daxgpS')
...
Farm:AddToggle('AutoFarm', {
    ...
    Default = false,
    Tooltip = 'Farm Katakuri',
})

Toggles.AutoFarm:OnChanged(function(va)
getgenv().AutoKatakuri = va
end)
            ...
            game:GetService("RunService").Heartbeat:Connect(function()
                pcall(function()
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if getgenv().AutoKatakuri and StartCakeMagnet and (v.Name == "Cookie Crafter [Lv. 2200]" or v.Name == "Cake Guard [Lv. 2225]" or v.Name == "Baking Staff [Lv. 2250]" or v.Name == "Head Baker [Lv. 2275]") and (v.HumanoidRootPart.Position - POSCAKE.Position).magnitude <= 370 then
                                ...
                                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do 
                                    if v.Name == "Cake Prince [Lv. 2300] [Raid Boss]" then
                                        repeat wait()
                                            ...
                                            v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                            v.HumanoidRootPart.CanCollide = false
                                            getgenv().ToTarget(v.HumanoidRootPart.CFrame * CFrame.new(5,30,6))                         
                                            game:GetService'VirtualUser':CaptureController()
                                            game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                        until getgenv().AutoKatakuri == false or not v.Parent or v.Humanoid.Health <= 0
                                    end    
                                end    
                            else
                                ...
                                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do  
                                    if (v.Name == "Baking Staff [Lv. 2250]" or v.Name == "Head Baker [Lv. 2275]" or v.Name == "Cake Guard [Lv. 2225]" or v.Name == "Cookie Crafter [Lv. 2200]") and v.Humanoid.Health > 0 then
                                        repeat wait()
                                            ...
                                            game:GetService'VirtualUser':CaptureController()
                                            game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                        until getgenv().AutoKatakuri == false or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") or not v.Parent or v.Humanoid.Health <= 0
                                    end
                                end
                            else
...
Farm:AddToggle('SpawnFarmVA', {
    Text = 'Auto Spawns Katakuri',
    Default = true,
    Tooltip = 'Spawns Katakuri',
})

Toggles.SpawnFarmVA:OnChanged(function(va)
...
local SettingFarm = Tabs.Main:AddRightGroupbox('Setting Farm')
...
SettingFarm:AddToggle('FastAttack', {
    Text = 'Fast Attack',
    Default = false,
    Tooltip = 'Fast Attack',
})

Toggles.FastAttack:OnChanged(function(va)
getgenv().FastAttack = va
end)
...
local RaceV4 = Tabs.Main:AddRightGroupbox('Race V4')

RaceV4:AddToggle('AutoTrial', {
    Text = 'Auto Trial V4',
    Default = false,
    Tooltip = 'Auto Trial V4 Race',
})

Toggles.AutoTrial:OnChanged(function(va)
getgenv().AutoTrialV4 = va
end)
						...
						if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
							pcall(function()
								repeat wait(.1)
									...
									v.HumanoidRootPart.CanCollide = false
									sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
								until not getgenv().AutoTrialV4 or not v.Parent or v.Humanoid.Health <= 0
							end)
						end
					end
...
RaceV4:AddToggle('TeleportRaceDoor', {
    Text = 'Teleport Race Door',
    Default = false,
    Tooltip = 'Teleport Race Door',
})

Toggles.TeleportRaceDoor:OnChanged(function(va)
getgenv().Teleracedoor = va
end)
...
local MysticIsland = Tabs.Main:AddLeftGroupbox('Mystic Island')

MysticIsland:AddToggle('MysticIslandc', {
    Text = 'Teleport Mystic Island',
    Default = false,
    Tooltip = 'Tween To Mystic Island',
})

Toggles.MysticIslandc:OnChanged(function(va)
getgenv().TLMystic = va
end)
...
MysticIsland:AddToggle('Gearc', {
    Text = 'Teleport Gear',
    Default = false,
    Tooltip = 'Tween To Gear',
})

Toggles.Gearc:OnChanged(function(va)
getgenv().TweenGear = va
end)
