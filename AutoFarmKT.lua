        ...
        pcall(
            function()
                ...
                while wait(time) do
                    ...
                    StastDefense:Set("Defense : " .. game:GetService("Players").localPlayer.Data.Stats.Defense.Level.Value)
                    ...
                    StastDevilFruit:Set("DevilFruit : " .. game:GetService("Players").localPlayer.Data.Stats["Demon Fruit"].Level.Value)
